...
/**
 * @description Retrieves the top level document being commented (to make it the source document of the event) as some
 *              implementations fail on this. The top level document is the one holding the notification subscriptions,
 *              not the comments hierarchy below.
 * @since 5.5
 * @author vpasquier
 */
